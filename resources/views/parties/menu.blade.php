            ...
            <div class="header-center">
                <nav id="sideNav" class="mainmenu-nav navbar-example2">
                    ...
                    <ul class="primary-menu nav nav-pills">
                        ...
                        <li class="nav-item"><a class="nav-link smoth-animation" href="#portfolio">Mes Réalisation</a>
                        </li>
    ...
    <div class="inner">
        ...
        <div class="content">
            <ul class="primary-menu nav nav-pills">
                ...
                <li class="nav-item"><a class="nav-link smoth-animation" href="#portfolio">Mes Réalisation</a></li>
