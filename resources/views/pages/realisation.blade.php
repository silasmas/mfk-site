  ...
  <div id="portfolio" class="rn-project-area portfolio-style-two rn-section-gap">
    <div class="container">
        <div class="row">
                    ...
                    <div class="portfolio-single">
                        <div class="row direction">
                            ...
                            <div class="col-lg-7 col-xl-7">
                                <div class="thumbnail">
                                    <img src="{{ asset('assets/photos/ph3.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carousel-item">
                    <div class="portfolio-single">
                        <div class="row direction">
                            ...
                            <div class="col-lg-7 col-xl-7">
                                <div class="thumbnail">
                                    <img src="{{ asset('assets/photos/ov2.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carousel-item">
                    <div class="portfolio-single">
                        <div class="row direction">
                            ...
                            <div class="col-lg-7 col-xl-7">
                                <div class="thumbnail">
                                    <img src="{{ asset('assets/photos/ov3.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
